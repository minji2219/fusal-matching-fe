...
const MembershipPage = () => {
  ...
  const checkDuplication = async (e) => {
    try {
      DuplicationCheck = await axios.post(
        "https://6f2b-121-147-100-85.ngrok-free.app/teams/check-id",
        {
          idORNick: id,
          headers: {
      ...
      <div className="membershipbox">
        ...
        <div className="membership_inputs">
          ...
          >
            ...
            <button
              className="check_btn"
              style={{ position: "absolute", left: "470px" }}
              onClick={(e) => {
                checkDuplication(e);
              }}
            >
          ...
          <button className="btn_complete" onClick={fetchMembership}>
            완료
          </button>
        </div>
      </div>
